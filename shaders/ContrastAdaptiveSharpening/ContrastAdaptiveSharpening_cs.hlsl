...
// the worst case is red and green at 0 and blue high enough
// so that the luminance is HdrDllPluginConstants.HDRPeakBrightnessNits
#if HDR_BT2020
	static const float BlueFactor = 0.059265948832035064697265625f;
#else
