...
static const float3x3 BT709_2_AP0D65 = float3x3(
	0.43379461765289306640625,       0.376462161540985107421875,    0.189743220806121826171875,
	0.088556401431560516357421875,   0.809415638446807861328125,    0.102027960121631622314453125,
	0.01774938963353633880615234375, 0.109539218246936798095703125, 0.8727114200592041015625);

static const float3x3 AP0D65_2_BT709 = float3x3(
	 2.5532894134521484375,          -1.13030064105987548828125,    -0.422988712787628173828125,
	-0.2771895825862884521484375,     1.3780276775360107421875,     -0.100838042795658111572265625,
	-0.0171376205980777740478515625, -0.14997617900371551513671875,  1.167113780975341796875);
...
float3 BT709_To_AP0D65(float3 color)
{
	return mul(BT709_2_AP0D65, color);
}

float3 AP0D65_To_BT709(float3 color)
{
	return mul(AP0D65_2_BT709, color);
}
